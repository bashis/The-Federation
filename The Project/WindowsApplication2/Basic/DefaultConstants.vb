...
Public Class DefaultConstants
    ...
    Public Shared PPVsPerYear As Integer = 9 'Actually 10 including 0
    ''' <summary>
    ''' The first index is Ammount of promotion (bigger = better)
    ''' The second index is price
    ''' </summary>
    ''' <remarks></remarks>
    Public Shared PPVPromotionCosts(,) As Integer = {{20, 50000}, {50, 200000}, {80, 500000}}
