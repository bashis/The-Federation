...
Public Class WSelect
    ...
    Private Sub WSelect_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        WrestlerSelectionDialog1.autofill(MData.mywrestlers)
    End Sub

    Private Sub WrestlerSelectionDialog1_Load(sender As Object, e As EventArgs) Handles WrestlerSelectionDialog1.Load
    End Sub
End Class
