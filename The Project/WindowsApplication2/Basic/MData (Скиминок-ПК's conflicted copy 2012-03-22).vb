...
Public Class MData
    ...
    Private Sub FillBrands()
        For i = 0 To Basic.P_Names.Length - 1
            ComboBox1.Items.Add(Basic.P_Names(i).ToString)
        Next
    ...
    Private Sub WrestlerSelectionDialog1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles WrestlerSelectionDialog1.Load
