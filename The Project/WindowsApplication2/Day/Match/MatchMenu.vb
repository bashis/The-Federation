Public Class MatchMenu
    ...
    Private Function winner() As Integer
        ...
        For i = 0 To number_of_wrestlers - 1
            For j = 0 To DefaultConstants.n_of_perks_at_once - 1
                If wr(i).perks(j) = 7 Then 'Drunkie
                    chance = RosterViewerForm.random(0, 9)
                End If
            Next
        Next
        If chance = 1 Then
        ...
        If isWinner Then
            ...
            End If
            If RosterViewerForm.random(0, 10) = 1 Then
                isInterfere = True
10:             cnt += 1
                If cnt >= MData.wrestlers.Length - 1 Then GoTo 20 'Haters gonna hate
                interfere = RosterViewerForm.random(0, MData.wrestlers.Length - 1)
                ...
                For i = 0 To number_of_wrestlers - 1
                    ...
                    End If
                Next
                prepwinner = RosterViewerForm.random(0, number_of_wrestlers - 1)
                If MData.wrestlers(interfere).Gimmick.isFace = wr(prepwinner).Gimmick.isFace Then
                    Return (prepwinner)
                Else
                    GoTo 10
                End If
...
20:
                ...
                rkoef = RosterViewerForm.random(3, 9)
                For i = 0 To number_of_wrestlers - 1
                    increaser = 1
                    For j = 0 To DefaultConstants.n_of_perks_at_once - 1
                    ...
                    tmp = RosterViewerForm.random(lowerbound, upperbound)
    ...
    Private Sub count_match_overall()
        ...
        If number_of_wrestlers > 0 Then
            For i = 0 To number_of_wrestlers - 1
                Pop += RosterViewerForm.random(wr(i).stats(0) * 2 / 3, wr(i).stats(0) * 3 / 2) 'Wrestling
                Pop += RosterViewerForm.random(wr(i).stats(4) * 2 / 3, wr(i).stats(0) * 3 / 2) 'Fan-Base
                '                MatchQuality += Form1.random(wr(i).stats(0) / 2, wr(i).stats(0) * 3 / 2) ' Wrestling Again
                Danger += RosterViewerForm.random(wr(i).stats(3) / 2, wr(i).stats(3)) 'Insanity


                'Check if the wresrler is perspective or worthless
                For j = 0 To DefaultConstants.n_of_perks_at_once - 1
                    If wr(i).perks(j) = 4 Then
                        wr_add = RosterViewerForm.random(CInt(wr(i).stats(0)), CInt(wr(i).stats(0) * 1.5)) * 1.5
                    ElseIf wr(i).perks(j) = 5 Then
                        wr_add = RosterViewerForm.random(CInt(wr(i).stats(0) / 4), CInt(wr(i).stats(0) / 2)) / 2
                    ElseIf wr(i).perks(j) = 3 Then
                        number_of_daredevils += 1
                    Else
                        wr_add = RosterViewerForm.random(wr(i).stats(0) * 2 / 3, wr(i).stats(0) * 4 / 3)
                    End If
                Next
    ...
    Private Sub find_summ()
        ...
        For i = 0 To number_of_wrestlers - 1
            ...
            result_stats.Text = result_stats.Text & wr(i).name & vbCrLf '& " " & cnt(i) & vbCrLf
    ...
    Public Sub Simulate()
        ...
        FillHeaderImage()
    End Sub
    Private Sub FillHeaderImage()
        Header.bg.BorderStyle = BorderStyle.None
        Try
            Header.Draw(Basic.Promotions(Basic.Promotion).ShowBGPics(Basic.CurrentDate.DayOfWeek), ThisMatch.wrestlers.ToList, ThisMatch.Name)
        Catch ex As Exception
            Header.bg.BackColor = Color.Black
        End Try
        NamesLabel.Text = ThisMatch.Name
...
10:
            temp1 = RosterViewerForm.random(0, number_of_wrestlers - 1)
            temp2 = RosterViewerForm.random(0, number_of_wrestlers - 1)
            If temp1 = temp2 Then
                GoTo 10
            End If
            '   MsgBox("1")
20:
    ...
    Private Function Local_looser(ByVal people As Object) As Integer
        ...
        ElseIf people.length = 3 Then
            ...
            For i = 0 To 2
                team(i, 0) = RosterViewerForm.random(0, 2)
            Next
            ...
            Else
                ...
                For i = 0 To 2
                    ...
                    Dim upperbound As Integer = Int(wr(i).stats(5) * increaser)
                    '  If upperbound < lowerbound Then upperbound = lowerbound
                    overall(i) = RosterViewerForm.random(lowerbound, upperbound)
                    team(i, 1) = overall(i)
                Next
                '===============================================
                For i = 0 To 2
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs)
        Dim res As Double = Val(InputBox("Input the number:"))
        '  MatchStars1.value = res

        MatchStars1.rebuild(res)
    End Sub
    Dim matchname As String
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles ImageButton1.Click
        '   Dim mh As MatchHighlights = New MatchHighlights
        Dim mh As NewMatchGenerator = New NewMatchGenerator
        '   '  mh.MatchName = matchname
        '  mh.Wrestlers = New List(Of WModel)
        mh.Winner = const_winner
        '  mh.Wrestlers.AddRange(wr)
        mh.MyMatch = ThisMatch

        '    mh.Highlights = {"The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "The match starts...", "And a great chokeslam by Kane!", "Kane goes for the pin!", "1...2...3!", "Kane wins! What a match!"}
        mh.Show()
    End Sub
    ...
    Private Sub ImageButton1_MouseDown(sender As Object, e As MouseEventArgs) Handles ImageButton1.MouseDown

    End Sub

    Private Sub MatchStars1_Load(sender As Object, e As EventArgs) Handles MatchStars1.Load
