Public Class AddPPV
    ...
    Public ThisPPV As Promotion.PayPerView
    Public Promotion As Integer
    Private Sub Button4_Click(sender As System.Object, e As System.EventArgs) Handles Button4.Click
        template.Image = My.Resources.Others_PPV
    End Sub
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        If Not TextBox1.Text = "" Then
            If ListView1.SelectedItems.Count > 0 Then
                ...
                Else
                    ThisPPV.PImage = My.Resources.Others_PPV
                End If
                Basic.Promotions(Basic.Promotion).AddPPV(ThisPPV.PName, ThisPPV.PDate, ThisPPV.PImage)

                Schedule.Calendar1.Clear()
                Schedule.Calendar1.Fill()
                Me.Close()
    ...
    Private Sub Button5_Click(sender As System.Object, e As System.EventArgs) Handles Button5.Click
        ...
        i1 = RosterViewerForm.random(0, Adj.Length - 1)
        i2 = RosterViewerForm.random(0, Obj.Length - 1)
